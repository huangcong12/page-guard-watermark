...
<div id="page-wpfooter" role="contentinfo">
    <div class="wpforms-footer-promotion">
        <p>Made with ♥ by the WPForms Team</p>
        <ul class="wpforms-footer-promotion-links">
            <li>
                <a href="https://wordpress.org/support/plugin/wpforms-lite/" target="_blank" rel="noopener noreferrer">Support</a><span>/</span>
            </li>
            <li>
                <a href="https://wpforms.com/docs/?utm_campaign=liteplugin&amp;utm_source=WordPress&amp;utm_medium=Plugin%20Footer&amp;utm_content=Plugin%20Documentation&amp;utm_locale=en_US"
                   target="_blank" rel="noopener noreferrer">Docs</a><span>/</span></li>
            <li>
                <a href="https://www.facebook.com/groups/wpformsvip/" target="_blank" rel="noopener noreferrer">VIP
                    Circle</a><span>/</span></li>
            <li>
                <a href="http://wd.com/wp-admin/admin.php?page=wpforms-about">Free Plugins</a></li>
        </ul>
        <ul class="wpforms-footer-promotion-social">
            <li>
                <a href="https://www.facebook.com/wpforms" target="_blank" rel="noopener noreferrer">
                    <svg width="16" height="16" aria-hidden="true">
                        <path fill="#A7AAAD"
                              d="M16 8.05A8.02 8.02 0 0 0 8 0C3.58 0 0 3.6 0 8.05A8 8 0 0 0 6.74 16v-5.61H4.71V8.05h2.03V6.3c0-2.02 1.2-3.15 3-3.15.9 0 1.8.16 1.8.16v1.98h-1c-1 0-1.31.62-1.31 1.27v1.49h2.22l-.35 2.34H9.23V16A8.02 8.02 0 0 0 16 8.05Z"></path>
                    </svg>
            ...
            <li>
                <a href="https://www.youtube.com/c/Wpformsplugin" target="_blank" rel="noopener noreferrer">
                    <svg width="17" height="16" aria-hidden="true">
                        <path fill="#A7AAAD"
                              d="M16.63 3.9a2.12 2.12 0 0 0-1.5-1.52C13.8 2 8.53 2 8.53 2s-5.32 0-6.66.38c-.71.18-1.3.78-1.49 1.53C0 5.2 0 8.03 0 8.03s0 2.78.37 4.13c.19.75.78 1.3 1.5 1.5C3.2 14 8.51 14 8.51 14s5.28 0 6.62-.34c.71-.2 1.3-.75 1.49-1.5.37-1.35.37-4.13.37-4.13s0-2.81-.37-4.12Zm-9.85 6.66V5.5l4.4 2.53-4.4 2.53Z"></path>
                    </svg>
    ...
    <p id="footer-left" class="alignleft">
        Please rate <strong>WPForms</strong> <a
                href="https://wordpress.org/support/plugin/wpforms-lite/reviews/?filter=5#new-post" target="_blank"
                rel="noopener noreferrer">★★★★★</a> on <a
                href="https://wordpress.org/support/plugin/wpforms-lite/reviews/?filter=5#new-post" target="_blank"
                rel="noopener">WordPress.org</a> to help us spread the word. </p>
